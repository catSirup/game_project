...
public class Enemy3 : MonoBehaviour {
	...
	void Start () {
        ...
        speed = TopMoveSpeedValueManager.enemy3Speed;
	...
	void Update () {
        ...
        {
            this.speed = TopMoveSpeedValueManager.enemy3Speed;
        ...
        else if (!protectTop.gameObject.activeInHierarchy || TimerValueManager.closeTimer)
        {
