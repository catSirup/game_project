...
// 씬의 상태들을 나타내기 위한 열거형.
public enum SceneState { LOGO, TITLE, MAIN, WORDGAME, YABAWEE, COLOR, CATCHMAIND, TEMP }
...
public class SceneManager : MonoBehaviour {
    ...
    private SceneState prevState;   // 이전 상태의 씬.
    ...
    public SceneState GetCurState() { return curState; }
    public void SetPrevState(SceneState state) { prevState = state; }
    public SceneState GetPrevState() { return prevState; }
}
